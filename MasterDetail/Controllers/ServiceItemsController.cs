...
namespace MasterDetail.Controllers
{
    public class ServiceItemsController : Controller
    {
        ...
        {
            ServiceItem[] matchingServiceItems = String.IsNullOrEmpty(term)
                ? null
                : _applicationDbContext.ServiceItems
                                      .Where(s => s.ServiceItemName.Contains(term) ||
                                             s.ServiceItemCode.Contains(term)).ToArray();
