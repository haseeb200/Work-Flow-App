namespace MasterDetail.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            Sql(@"CREATE FUNCTION dbo.GetSumPartsAndLabor(@workOrderId INT)
            ...
            SELECT @partSum = Sum(ExtendedPrice)
            FROM
            Parts
            ...
            RETURN ISNULL(@partSum,0) + ISNULL(@laborSum,0);
            END");

            Sql("ALTER TABLE dbo.WorkOrders ADD Total as dbo.GetSumPartsAndLabor(WorkOrderId)");
