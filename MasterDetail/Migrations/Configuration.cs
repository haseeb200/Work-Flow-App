namespace MasterDetail.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MasterDetail.Context.ApplicationDbContext>
    {
        ...
        protected override void Seed(MasterDetail.Context.ApplicationDbContext context)
        {
